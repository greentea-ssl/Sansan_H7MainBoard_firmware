...
#else
	m_param.wheel_pos_theta_deg[0] = 65;
	m_param.wheel_pos_theta_deg[1] = 140;
	m_param.wheel_pos_theta_deg[2] = -140;
	m_param.wheel_pos_theta_deg[3] = -65;
#endif
...
bool OmniWheel::setup()
{
	...
	position_pi_x.setParam(4.0, 0.0, 1E-3);
	position_pi_y.setParam(4.0, 0.0, 1E-3);
	position_pi_theta.setParam(4.0, 0.0, 1E-3);
